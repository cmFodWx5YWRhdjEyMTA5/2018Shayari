...
public class EnglishFunnyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_funny);
                    ...
                    if (isComplete) {
                        ...
                        if (data != null) {
                            if (data.getResult() != null) {
                                ...
                                ShayariAdapter shayariAdapter = new ShayariAdapter(EnglishFunnyActivity.this, results);
                                recyclerView.setAdapter(shayariAdapter);
                                shayariAdapter.notifyDataSetChanged();
                            }
                        }
                    } else {
                        Utility.alertForErrorMessage("Some Problem Try Again", EnglishFunnyActivity.this);
                    }
