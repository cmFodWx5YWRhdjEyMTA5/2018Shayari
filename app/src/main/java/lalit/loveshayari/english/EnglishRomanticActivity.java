...
public class EnglishRomanticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_romantic);
                    ...
                    if (isComplete) {
                        ...
                        if (data != null) {
                            if (data.getResult() != null) {
                                ...
                                ShayariAdapter shayariAdapter = new ShayariAdapter(EnglishRomanticActivity.this, results);
                                recyclerView.setAdapter(shayariAdapter);
                                shayariAdapter.notifyDataSetChanged();
                            }
                        }
                    } else {
                        Utility.alertForErrorMessage("Some Problem Try Again", EnglishRomanticActivity.this);
                    }
