...
public class EnglishSadActivity extends AppCompatActivity {
                    ...
                    if (isComplete) {
                        ...
                        if (data != null) {
                            if (data.getResult() != null) {
                                ...
                                ShayariAdapter shayariAdapter = new ShayariAdapter(EnglishSadActivity.this, results);
                                recyclerView.setAdapter(shayariAdapter);
                                shayariAdapter.notifyDataSetChanged();
                            }
                        }
                    } else {
                        Utility.alertForErrorMessage("Some Problem Try Again", EnglishSadActivity.this);
                    }
