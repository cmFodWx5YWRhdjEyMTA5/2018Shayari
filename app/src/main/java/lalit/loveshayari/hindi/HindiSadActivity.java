...
public class HindiSadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hindi_sad);
                    ...
                    if (isComplete) {
                        ...
                        if (data != null) {
                            if (data.getResult() != null) {
                                ...
                                ShayariAdapter shayariAdapter = new ShayariAdapter(HindiSadActivity.this, results);
                                recyclerView.setAdapter(shayariAdapter);
                                shayariAdapter.notifyDataSetChanged();
                            }
                        }
                    } else {
                        Utility.alertForErrorMessage("Some Problem Try Again", HindiSadActivity.this);
                    }
